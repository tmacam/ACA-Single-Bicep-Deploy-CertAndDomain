...
public static class AzureDnsOwnershipVerificationResourceExtension
{
        ...
        IResourceBuilder<AzureContainerAppEnvironmentResource> cae)
    {
        ...
        void configureInfrastructure(AzureResourceInfrastructure infrastructure)
        {
            ...
            // resources and avoid this boilerplate here. Regardless, `dnsZone` is
            // assumed to be an existing resource not created under Aspire so we
            ...
            var containerAppEnvironment = (ContainerAppManagedEnvironment)cae.Resource.AddAsExistingResource(infrastructure);
